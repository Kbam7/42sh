...
/*   Updated: 2016/08/05 10:48:56 by kbamping         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//dprintf(2, "process_pipe() ---- Here  - 2.1 -- s->n->pipes = %d\tsub_cmd.strings[i] = >%s< -- NULL\n", s->n_pipes, sub_cmd.strings[i]); // debug
...
//dprintf(2, "process_pipe() ---- Here  - 2.2 -- s->n->pipes = %d\tsub_cmd.strings[i] = >%s<\n", s->n_pipes, sub_cmd.strings[i]); // debug
...
//dprintf(2, "process_pipe() ---- Here - 3 -- s->n_pipes = %d\n", s->n_pipes); // debug
