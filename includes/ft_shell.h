...
/*   Updated: 2016/09/11 17:02:45 by kgani            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void						init_env(t_shell *s, int argc, char **argv,
		char **envp);
...
char						*analyze_redir(char **str, char dir, char **cmd,
		t_shell *s);
...
char						*check_prefix(char **str, int pos, char **cmd,
		t_shell *s);
...
void						ft_echo_string(char **new_str, char *arg,
		int *triggerer, int *flag);
int							ft_echo_esc(char **new_str, char *arg, int pos,
		int trigger);
int							ft_echo_esc_char(char **new_str, int esc_char);
int							ft_echo_skip(char *str);
int							ft_echo_isflag(char *arg, int *flag, int *new_line);
void						ft_echo_env(char **new_str, char *str, int *flag,
		t_shell *s);
...
int							ft_set(int env_type, char *name, char *val,
		t_shell *s);
